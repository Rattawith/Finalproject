...
function Machine03() {
  ...
  const [isCompleted, setIsCompleted] = useState<boolean>(() =>
    JSON.parse(localStorage.getItem("Machine03_isCompleted") || "false")
  );
  const [lastPlayedTime, setLastPlayedTime] = useState<number>(() =>
    parseFloat(localStorage.getItem("Machine03_lastPlayedTime") || "0")
  );
    ...
    <>
      {currentVideoUrl && (
        ...
        <div className="video-content">
          <h2>Lecture 3 : ML - Data Distributions and Histograms</h2>
          {isCompleted && (
