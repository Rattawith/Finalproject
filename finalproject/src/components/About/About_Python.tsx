...
function About_Python() {
  return (
    ...
    <Link to="/educations_python?courseId=01">Click</Link>
    <h3>02 Python - Get Started</h3>
    <p className="course-duration">2 นาที</p>
    <Link to="/educations_python?courseId=02">Click</Link>
    <h3>03 Python - Syntax</h3>
    <p className="course-duration">2 นาที</p>
    <Link to="/educations_python?courseId=03">Click</Link>
    <h3>04 Python - Comments</h3>
    <p className="course-duration">1 นาที</p>
    <Link to="/educations_python?courseId=04">Click</Link>
    <h3>05 Python - Variables</h3>
    <p className="course-duration">2 นาที</p>
    <Link to="/educations_python?courseId=05">Click</Link>
    ...
    <p className="course-duration">2 นาที</p>
    <Link to="/educations_python?courseId=09">Click</Link>
    </div>
    </>
  )
}
